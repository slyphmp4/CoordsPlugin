...
import com.slyph.coords.listener.BiomeListener;
...
public final class CoordsPlugin extends JavaPlugin {
    ...
    private BiomeAlertManager  biomeAlerts = new BiomeAlertManager();
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager()
                .registerEvents(new BiomeListener(this, biomeAlerts), this);
    ...
    private void registerCommand() {
        ...
        if (cord != null) {
            ...
            getLogger().severe("Command 'cord' not found in plugin.yml");
    }

    public void startTask() {
        int interval = getConfig().getInt("update-interval-ticks", 20);
        coordinateTask = new CoordinateTask(this, adventure, biomeAlerts);
